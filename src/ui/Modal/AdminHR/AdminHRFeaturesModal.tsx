...
import { useCreateUserFieldMutation } from "../../../redux/features/admin/adminUsers/adminUsers";
import { inputStructure } from "../../../pages/Admin/fakeData";

/* eslint-disable @typescript-eslint/no-explicit-any */

const AdminHRFeaturesModal = ({
  ...
  const [createUserField] = useCreateUserFieldMutation();
...
export default AdminHRFeaturesModal;
