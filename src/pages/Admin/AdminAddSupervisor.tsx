                  ...
                  {field?.inputType === "file" ? (
                    ...
                    >
                      ...
                      <Upload
                        ...
                        className=""
                      >
                        <div className="md:w-[320px] w-full p-4 border border-dashed border-gray-400 rounded-lg flex flex-col items-center justify-center bg-transparent hover:border-primary transition-all duration-300 cursor-pointer">
