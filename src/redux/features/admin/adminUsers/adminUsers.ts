...
const adminUsersApi = baseApi.injectEndpoints({
    endpoints: (builder) => ({
        ...
        updateUser: builder.mutation({
            ...
            invalidatesTags: [tagTypes.user, tagTypes.hubManageSpokeManager, tagTypes.hubManagerFieldOfficer],
        }),
        ...
        deleteUser: builder.mutation({
            ...
            invalidatesTags: [tagTypes.user, tagTypes.hubManagerFieldOfficer],
        }),
